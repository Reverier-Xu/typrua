...
Window {
    ...
    //             const b = 10; // Increase the corner size slightly
    //             if (p.x < b && p.y < b)
    ...
    //             let e = 0;
    //             // console.log(width - b);
    //             if (p.x < 2*b) { e |= Qt.LeftEdge }
    //             if (p.x >= width - 2*b) { e |= Qt.RightEdge }
    //             if (p.y < 2*b) { e |= Qt.TopEdge }
    //             if (p.y >= height - 2*b) { e |= Qt.BottomEdge }
